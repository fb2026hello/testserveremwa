...
export const SuperbackerEmailB = ({ name }: EmailProps) => {
    return (
        <Html>
            <Head />
            <Preview>Why I built an open-source ecosystem instead of buying a plastic box.</Preview>
            <Body style={main}>
                <Container style={container}>
                    ...
                    <Section style={box}>
                        ...
                        <ul style={{ paddingLeft: '20px', margin: 0 }}>
                            ...
                            <li style={listItem}>
                                <strong>Modularity:</strong> Built on standard profiles, adaptable to Prusa, Ender, or custom rigs.
                            </li>
                        </ul>
                    </Section>

                    <Text style={text}>
                        Here is the deal: I don't care if you choose to self-source the components following our Bill of Materials, or if you buy our kit to support us. All I care is that I have helped another maker.
                    </Text>
...
export default SuperbackerEmailB;

// STYLES (Brand - from snippet, slightly adapted)
